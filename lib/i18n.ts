...
const translations = {
  en: {
    ...
    "tr_t3po": "T3PO",
    "tr_clause": "Clause",
    "tr_streaming_multilingual": "Multilingual mode translates whole sentences. Switch to Between or From→To to use clause / live translation.",
  ...
  zh: {
    ...
    "tr_t3po": "同传",
    "tr_clause": "分句",
    "tr_streaming_multilingual": "多语言模式按整句翻译。切换到“双向”或“单向”模式才能使用分句 / 同传。",
